...
public class SystemCaesar {
    ...
    private int rolling(int value, int index) { return value;
    }

    public StreamMessage getCipher() {return null;}

    public StreamMessage getDeCipher(String message) { return new StreamMessage(message);}
    }
